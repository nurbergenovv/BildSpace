                    ...
                    <div class="container centerMaxWidthContainer heroHeader">
                        <div class="heroHeader-body">
                            <div class="heroHeader-header">
                                <h1 class="heroHeader-title">Hotels</h1>
                                <p class="heroHeader-subtitle">
                                <p>Do you want to relax in great places? Let's go through our list of best hotels of Kazakhstan</p>
                                </p>
                            </div>
                        ...
                        <div class="categories" style="display: flex ; justify-content: space-around;" >
                            <ul class="categories-list">
                                <li class="categories-item">
                                    <a href="hotel_filter.php" class="categories-link ">Hotel</a>
                                </li>
                                <li class="categories-item">
                                    <a href="hostel_filter.php" class="categories-link ">Hostel</a>
                                </li>
                            </ul>
                        </div>
                        <ul class="grid">
                            <?php
$myPosts = mysqli_query($con , "SELECT * from post WHERE  type = 'hostel' or type = 'hotel' ");
