                    ...
                    <div class="container centerMaxWidthContainer heroHeader">
                        <div class="heroHeader-body">
                            <div class="heroHeader-header">
                                <h1 class="heroHeader-title">Restaurants</h1>
                                <p class="heroHeader-subtitle">
                                <p>Do you want to enjoy best foods in Kazakhstan? You came to right address</p>
                                </p>
                            </div>
                        ...
                        <div class="categories" style="display: flex ; justify-content: space-around;" >
                            <ul class="categories-list">
                                <li class="categories-item">
                                    <a href="cafe_filter.php" class="categories-link ">Cafe</a>
                                </li>
                                <li class="categories-item">
                                    <a href="fastfood_filter.php" class="categories-link ">Fast-Food</a>
                                </li>
                                <li class="categories-item">
                                    <a href="restaurant_filter.php" class="categories-link ">Restaurant</a>
                                </li>
                            </ul>
                        </div>
                        <ul class="grid">
                            <?php
$myPosts = mysqli_query($con , "SELECT * from post WHERE  type = 'cafe' or type = 'fastfood' or type   = 'restaurant' ");
